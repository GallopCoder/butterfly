 ...
 * @Date 2018-08-23
 */
public class ExcelUtilWithResponse {

    private Logger log = LoggerFactory.getLogger(ExcelUtilWithResponse.class);
    ...
    public ExcelUtilWithResponse(String fileName, HashMap<String, List<?>> data, LinkedHashMap<String, String[][]> headers) {
